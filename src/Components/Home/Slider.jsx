                ...
                <div id="slide1" className="carousel-item relative w-full h-[650px]">
                    ...
                    <div className="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between">
                        ...
                        <div className="flex flex-col lg:gap-y-8 md:gap-y-6 gap-y-2 text-center">
                            <h2 className="text-white lg:text-5xl md:text-3xl text-3xl font-bold animate__animated animate__fadeInLeft">Welcome to the Shan&apos;s Estate</h2>
                            <h2 className="text-white lg:text-4xl md:text-2xl text-2xl font-bold animate__animated animate__fadeInLeft">Where your dream <span className="text-blue-600">land</span> begins</h2>
                            <div>
                ...
                <div id="slide2" className="carousel-item relative w-full h-[650px]">
                    ...
                    <div className="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-start">
                        ...
                        <div className="flex flex-col lg:gap-y-8 md:gap-y-6 gap-y-2 text-left flex-1">
                            <h2 className="text-white lg:text-5xl md:text-3xl text-3xl font-bold animate__animated animate__fadeInLeft">We are professional at our fields</h2>
                            <h2 className="text-white lg:text-4xl md:text-2xl text-2xl font-bold animate__animated animate__fadeInLeft">Meet our <span className="text-blue-800">brokers</span> for more</h2>
                            <div>
                            <button onClick={()=>navigate('/about')} className="bg-blue-800 text-white font-semibold border-2 border-white rounded-xl px-3 py-2 hover:bg-blue-300">Learn more</button>
                            </div>
                ...
                <div id="slide3" className="carousel-item relative w-full h-[650px]">
                    ...
                    <div className="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-end">
                        ...
                        <div className="flex flex-col lg:gap-y-8 md:gap-y-6 gap-y-2 text-right flex-1">
                            <h2 className="text-white lg:text-5xl md:text-3xl text-3xl font-bold animate__animated animate__fadeInLeft">We provide security <span className="text-blue-600">for you</span></h2>
                            <h2 className="text-white lg:text-4xl md:text-2xl text-2xl font-bold animate__animated animate__fadeInLeft">With our <span className="text-blue-800">expertise</span></h2>
                            <div>
                            <button onClick={()=>navigate('/about')} className="bg-blue-800 text-white font-semibold border-2 border-white rounded-xl px-3 py-2 hover:bg-blue-300">Learn more</button>
                            </div>
